# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2020-01-15 10:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateField(auto_now_add=True)),
                ('comment_num', models.BigIntegerField(default=0, null=True)),
                ('up_num', models.BigIntegerField(default=0, null=True)),
                ('down_num', models.BigIntegerField(default=0, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Article2Tag',
